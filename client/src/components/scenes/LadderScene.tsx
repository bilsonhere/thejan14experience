...
const LIFE_EVENTS_DB: LifeEvent[] = [
  ...
  },
  {
    ...
    description: "Once in a lifetime experienceevery single day 💍",
  ...
  },
  {
    ...
    buttonText: "I love mountains now! 🌄",
    icon: Mountain,
    color: "bg-teal-500",
    age: 12,
    priority: 1,
  ...
  },
  {
    ...
    buttonText: "SO ADORABLE I LOVE THEM ALHUMDULILLAH😭💕",
    icon: Cat,
    color: "bg-cyan-500",
    age: 19,
    priority: 4,
