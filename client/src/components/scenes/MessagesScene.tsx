...
const LETTERS: Letter[] = [
  { id: 1, from: 'Maryam', relation: 'Sissy', content: `Happy Birthdayyy aapii hope you doing well in college and honestly missing you a lott like you're literally my 2nd motherr and lowkey idk how to live without you but I'm tryingg yk and idk how to tc of mohammad and ali you can only handle them idk how you do that and at end best wishes from my side Inshaallah you have to buy me my dior bag (please i need it ),\nMaryam 🌸`, rotation: -4, size: 0.9, pinPosition: 'tl', folded: false, depth: 2, color: '#f8f9fa' },
  { id: 2, from: 'Fatima', relation: 'Long Distance Sissy', content: `Happy birthdayyy Afrah. I hope this year brings everything good into your life and you feel happy and loved more than ever like you always do to the people around you. You have the kindest and prettiest soul and thankyouu for always being there for me and i wish you all the best for everything. Loveee youu🫶🏻,\nFatima 🌸`, rotation: 5, size: 0.92, pinPosition: 'tr', folded: true, depth: 3, color: '#fff5f5' },
  { id: 3, from: 'Monira', relation: 'Mufasa Mom', content: `Happy belated birthday to the most beautiful girl of my life 🤍
You matter to me more than words can ever explain. Everything about you is beautiful—your smile, your heart, your kindness, and even your name feels like poetry. You carry so much grace so naturally that being around you feels comforting and inspiring at the same time.
And I can't believe that you're already 20 
On your 20th birthday, I wish you all thhe best this world has to offer—endless happiness, good health, success, and dreams that come true one by one. May this new chapter of your life be brighter, stronger, and even more beautiful than before.
Always remember, you are deeply loved, endlessly valued, and truly special to me—today and always,\nMonira 🌸`, rotation: -2, size: 0.88, pinPosition: 'bl', folded: false, depth: 4, color: '#fffdf5' },
  { id: 4, from: 'Lil Bro', relation: 'Bilsis heartbeat', content: `Hellllooooo, Afrahhhhhhhh\nFirst of all Happpyyyy Birthdayyyyyy to youuuuuu.So proud of you!!!!!!🥳🥳Just wanted to stay that you are truly an amazing soul. The way you make bilson (my idiot) happy and make him feel alive means a lot to me. Just remember even though I have never met you. You are truly great and deserve the whole world.\nAlhumdullillah,\n Aayush 🎮`, rotation: 6, size: 0.95, pinPosition: 'br', folded: true, depth: 1, color: '#f8f9fa' },
  ...
  { id: 7, from: 'Aditi', relation: 'Bilsi Therapist', content: `Happy Birthday Afrah🩶\nCongratulations for two decades around the sun. You are a really great human being with true kindness and compassion that’s rare in today’s world. I am lucky to have heard your narrated tales and know about your awe inspiring character. May God always help you with your aspirations. Keep shining like the bright star you are✨\n Aditi 🦋`, rotation: -3, size: 0.9, pinPosition: 'tl', folded: false, depth: 2, color: '#fcfcfc' },
];
