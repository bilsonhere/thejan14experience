...
const LETTERS: Letter[] = [
  ...
  { id: 5, from: 'Anjila', relation: 'Bilsi sissy', content: `Happy birthday 🤍 I hope today reminds you of how loved and appreciated you are. hope this year treats you kindly and gives you moments that feel as special as a perfect race weekend for your favorite team . wishing you happiness, peace all the good things today and always 💌\nAnjila 💕`, rotation: -7, size: 0.86, pinPosition: 'tl', folded: false, depth: 2, color: '#fff0f5' },
