...
const LETTERS: Letter[] = [
  { id: 1, from: 'Maryam', relation: 'Sissy', content: `Happy Birthdayyy aapii hope you doing well in college and honestly missing you a lott like you're literally my 2nd motherr and lowkey idk how live without but I'm tryingg yk and idk how to tc of mohammad and ali you can only handle them idk how you do that and at end best wishes from my side Inshaallah you have to buy me my dior bag (please i need it ),\nMaryam 🌸`, rotation: -4, size: 0.9, pinPosition: 'tl', folded: false, depth: 2, color: '#f8f9fa' },
